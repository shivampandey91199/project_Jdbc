			...
			<div class="row g-12">
				<div class="col-md-8 wow fadeInUp" data-wow-delay="0.1s">
					<div class="bg-light p-5 h-100 d-flex align-items-center">
						...
						<input type="hidden" name="s_id" value="<%=s.getId()%>">
							<div class="row g-3">
								<div class="col-md-12">
								...
								<div class="col-md-12">
									<div class="form-floating">
										<input type="text" class="form-control" id="name" name="s_price"
								...
								<div class="col-md-12">
									<div class="form-floating">
										<input type="text" class="form-control" id="name" name="s_duration"
								...
								<div class="col-md-12">
									<div class="form-floating">
										<input type="text" class="form-control" id="email" name="s_category"
